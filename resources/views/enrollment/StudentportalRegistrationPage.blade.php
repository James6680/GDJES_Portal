      ...
      <form class=" rounded-lg bg-main-green-secondary-50 flex flex-col items-center justify-center py-[2.5rem] px-[2.5rem] gap-[.9rem] w-10/12 " id="balikAralInfo" method="post" action="{{route('post.enrollment')}}">
        ...
        <div class="self-stretch flex flex-row items-center justify-center py-[1.5rem] px-[4.44rem]">
          ...
          <div class="rounded-481xl bg-main-green-secondary-200 h-[2.6rem] overflow-hidden flex flex-col items-center justify-center p-0">
            ...
            <div class="relative text-[1.20rem] leading-[140%] font-heading-2 text-main-green-secondary-300 text-left p-4">2</div>
        ...
        <div class="self-stretch flex flex-col items-start justify-start gap-[1rem]">
          ...
          <!-- Login Button -->
          <div id="loginButton" class="self-stretch rounded-lg flex flex-row items-center justify-center py-[1rem] px-[2.13rem] border-[1px] border-solid border-main-brown-primary-500 hover:box-border hover:shadow-darkslategray-200 hover:border-[2px] hover:border-solid hover:border-dimgray-100 cursor-pointer">
