        ...
        <div class="self-stretch flex flex-col items-start justify-start gap-[1rem]">
          ...
          <div class="self-stretch rounded-[5px] bg-main-background flex flex-col items-start justify-center p-[2rem] gap-[1.5rem] border-[1px] border-solid border-main-green-secondary-100">
            ...
            <div id="paaralanInfo" class="flex flex-col w-full">
              ...
              <div class="flex items-center mb-2">
                ...
                <input required id="cellphone_tablet" name="learning_info[]"  type="checkbox" value="cellphone/tablet" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">

                <label for="default-checkbox" class="ml-2 text-sm font-light text-gray-900 dark:text-gray-300">May sariling Cellphone/Tablet ang Bata</label>

              </div>

              <div class="flex items-center mb-2">

                <input id="computer" name="learning_info[]" type="checkbox" value="Computer" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                
                <label for="checked-checkbox" class="ml-2 text-sm font-light text-gray-900 dark:text-gray-300">May computer sa bahay</label>
              
              </div>

              <div class="flex items-center mb-2">
                <input id="no_gadget" name="learning_info[]" type="checkbox" value="No_gadget" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                <label for="default-checkbox" class="ml-2 text-sm font-light text-gray-900 dark:text-gray-300">Walang sariling gadget ang bata</label>
              </div>

              <div class="flex items-center mb-2">
                <input  id="tv" name="learning_info[]" type="checkbox" value="Tv" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                <label for="checked-checkbox" class="ml-2 text-sm font-light text-gray-900 dark:text-gray-300">May tv sa bahay</label>
              </div>

              <div class="flex items-center mb-2">
                <input  id="internet" name="learning_info[]" type="checkbox" value="Internet" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                <label for="default-checkbox" class="ml-2 text-sm font-light text-gray-900 dark:text-gray-300">May internet connection sa bahay</label>
              </div>

              <div class="flex items-center">
                <input   id="mobile_data" name="learning_info[]" type="checkbox" value="Mobile_data" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                <label for="checked-checkbox" class="ml-2 text-sm font-light text-gray-900 dark:text-gray-300">Mobile data lamang ang gamit para makaconnect sa internet</label>
              </div>
            </div>
          ...
          <div class="self-stretch rounded-[5px] bg-main-background flex flex-col items-start justify-center p-[2rem] gap-[1.5rem] border-[1px] border-solid border-main-green-secondary-100">
            ...
            <div id="paaralanInfo" class="flex flex-col w-full">
              ...
              <div class="flex items-center mb-2">
                ...
                <input id="4ps_yes" type="radio" value="1" name="distance_learning" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                
                <label for="default-radio-1" class="ml-2 text-sm font-light text-gray-900 dark:text-gray-300">Modular Printed</label>
              
              </div>
              
              <div class="flex items-center mb-2">
              
                <input id="modular_printed" type="radio" value="Modular_printed" name="distance_learning" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
              
                <label for="default-radio-2" class="ml-2 text-sm font-light text-gray-900 dark:text-gray-300">Modular Digital</label>
              
              </div>

              <div class="flex items-center mb-2">

                <input id="online" type="radio" value="Online" name="distance_learning" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                
                <label for="default-radio-1" class="ml-2 text-sm font-light text-gray-900 dark:text-gray-300">Online</label>
              
              </div>
              
              <div class="flex items-center mb-2">
              
                <input id="educational_television" type="radio" value="Educational_television" name="distance_learning" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
              
                <label for="default-radio-2" class="ml-2 text-sm font-light text-gray-900 dark:text-gray-300">Educational Television</label>
              
              </div>

              <div class="flex items-center mb-2">

                <input id="homeschooling" type="radio" value="Homeschooling" name="distance_learning" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                
                <label for="default-radio-1" class="ml-2 text-sm font-light text-gray-900 dark:text-gray-300">Homeschooling</label>
              
              </div>
              
              <div class="flex items-center">
              
                <input  id="blended" type="radio" value="Blended" name="distance_learning" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
              
                <label for="default-radio-2" class="ml-2 text-sm font-light text-gray-900 dark:text-gray-300">Blended</label>
          ...
          <div class="flex gap-2 w-full">  
            ...
            <div class="self-stretch rounded-lg bg-main-green-secondary-500 flex flex-row items-center justify-center py-[1rem] w-1/2  hover:bg-darkslategray-200 hover:shadow-darkslategray-200  [&_.next]:hover:text-main-brown-primary-50"> 
              ...
              type="submit" 
              id="nextBtn" 
              class="next cursor-pointer p-0 bg-[transparent] flex-1 relative text-[1rem] leading-[140%] uppercase font-medium font-button text-main-brown-primary-50 text-center inline-block">Submit</button>
