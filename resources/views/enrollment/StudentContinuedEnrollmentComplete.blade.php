      ...
      <form class=" rounded-lg bg-main-green-secondary-50 flex flex-col items-center justify-center py-[2.5rem] px-[2.5rem] gap-[1.4rem] w-10/12 
        ...
        <div class="self-stretch flex flex-col items-center justify-start gap-[2rem]">
          ...
          <div class="flex flex-col gap-[.7rem]">
            <div class="self-stretch relative text-[1.11rem] leading-[140%] font-button text-main-brown-primary-500 text-center font-semibold">Tagumpay na Naipasa ang Iyong Aplikasyon para sa Pag-eenroll para sa sunod na panuruang taon!</div>


            <div class="flex flex-col gap-[0rem] px-2">

              <div class="self-stretch relative text-[0.75rem] leading-[160%] font-button text-main-green-secondary-700 text-start">Maaari ka nang bumalik sa student portal sa pamamagitan ng pag-click sa button na nasa ibaba</a>
              </div>
          ...
          <div class="flex flex-col gap-[2rem]">
            ...
            <script>
              ...
              navigateButton.addEventListener("click", function() {
                  ...
                  var newURL = localStorage.getItem('appUrl') + "/student.announcements"; // Replace with the desired URL
