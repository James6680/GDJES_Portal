    ...
    <section class="flex-1 flex flex-col items-center justify-center gap-5 text-center text-xl text-white font-frl">
      ...
      <div class="h-28 flex flex-col items-center justify-center gap-[0.5rem] cursor-pointer" id="logoContainer">
        ...
        <div class="flex flex-col items-start justify-start">
          ...
          <h2 class="m-0 relative text-2xl leading-[140%] font-bold font-frl overflow-hidden text-ellipsis whitespace-nowrap">
            GREGORIA DE JESUS
          </h2>
        ...
        <form class=" rounded-lg bg-green-50 flex flex-col items-center justify-center lg:p-10 md:p-7 p-5 md:gap-2 gap-1 lg:w-[56rem] md:w-[43rem] w-[23rem]"
        ...
        method="post" 
         action="{{route('enrollment.StudentportalRegistrationPage1.post')}}">
          ...
          <h1 class="m-0 self-stretch relative lg:text-2xl md:text-xl text-base leading-[110%] font-bold font-frl  text-green-700 text-center ">Student Registration for First-time Enrollees</h1>
          
          <div class="self-stretch flex flex-col items-center justify-start md:gap-2 gap-1">

            <div class="self-stretch relative lg:text-base md:text-sm text-xs leading-[140%] font-button text-main-brown-primary-500 text-center">Welcome to the student portal registration form</div>

            <div class="self-stretch relative md:text-xs text-[10px] leading-[140%] font-button text-main-green-secondary-700 text-center">Please fill out all the necessary information below.</div>

          </div>
          
          <!-- Progress Bar -->
          <div class="self-stretch flex flex-row items-center justify-center py-3 xl:px-44 lg:px-20 md:px-16 px-16  md:py-6">
            ...
            <div class="flex-1 relative bg-green-200 h-1 overflow-hidden"></div>
          ...
          <div class="self-stretch flex flex-col items-start justify-start gap-[1rem]">
            ...
            <!--Radio Button Balik Aral -->
              <div id="balikAralInfo" class="self-stretch relative flex-col items-start justify-start">
                ...
                <div class="self-stretch flex flex-col items-start justify-start pb-4">
                  ...
                  <b class="relative md:text-sm text-xs font-medium leading-[140%] font-mulish text-black text-left" for="balikAral">Balik-aral ba ang batang ipapalista? <span class="text-red-600">*</span></b>
                ...
                <div class="flex items-center mb-4 font-mulish"> 
                  ...
                  <input 
                    ...
                    name="aralStatus" 
                    id="balikAralNo"
                    class="lg:w-4 lg:h-4 w-3 h-3 text-green-500 border-gray-300 focus:ring-green-500 dark:focus:ring-green-500 dark:ring-offset-gray-800 focus:ring-1 dark:bg-gray-100 dark:border-gray-600"
                    @if(isset($enrollment->aralStatus) && $enrollment->aralStatus == 'HINDI') checked @endif
                  >
                  
                  <label for="balikAralNo" class="ml-2 md:text-sm text-xs text-gray-900 dark:text-black">HINDI</label>
                ...
                <div class="flex items-start font-mulish">
                  ...
                  >
                  <label for="balikAralYes" class="ml-2 text-start md:text-sm text-xs text-gray-900 dark:text-black">OO dahil sya ay nag-DROP o huminto sa pag-aaral noong nakaraang taon</label>
            ...
            <!-- Next Button -->
            <div class="self-stretch rounded-lg bg-green-500 flex flex-row items-center justify-center lg:py-3 py-2.5 px-8 hover:text-white hover:shadow-md hover:shadow-green-700/50 hover:bg-green-900">
              
              <button 
              type="button" 
              id="nextButton"
              class="next cursor-pointer p-0 bg-[transparent] flex-1 relative lg:text-base text-sm leading-[140%] uppercase font-medium font-mulish text-brown-50 text-center inline-block" 
              onclick="showNextSet()">
              Next
              </button>
          ...
          <div class="self-stretch flex flex-col items-start justify-start gap-3">
            ...
            <div class="self-stretch relative lg:text-sm text-xs leading-[140%] font-mulish text-brown-500 text-center overflow-hidden text-ellipsis whitespace-nowrap">Already have an account?</div>
            
            <!-- Login Button -->
            <div class="self-stretch rounded-lg flex flex-row items-center justify-center lg:py-2.5 py-2 px-8 border-[1px] border-solid border-brown-500 hover:box-border hover:border-brown-600 hover:border-[2px] hover:border-solid hover:border-dimgray-100 cursor-pointer">

              <!--id="loginButton"  -->
              <a href="{{ route('students_login_from') }}"
                
                class="cursor-pointer p-0 bg-[transparent] flex-1 relative lg:text-base text-sm leading-[140%] uppercase font-mulish text-brown-500 text-center inline-block overflow-hidden text-ellipsis whitespace-nowrap">
                login here
              </a>
