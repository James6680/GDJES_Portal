...
<div class="p-4 sm:ml-64 w-full h-auto hidden">
  ...
  <section 
    ...
    <ul class="m-o p-0 w-full h-auto text-white">
      <li class="py-5 border-b-2 border-green-50">
        <a href="https://www.facebook.com/photo?fbid=772548511547342&set=a.481770427291820"
          ...
          <span class="font-mulish font-normal text-white/60 text-xs md:text-sm lg:text-base">Date Published 1</span>
        </a>
      </li>
      <li class="py-5 border-b-2 border-green-50">
        <a href="https://www.youtube.com/watch?v=rKWLpH1fLMI" class="flex flex-col justify-between align-middle">
          ...
          <span class="font-mulish text-white/60 font-normal text-xs md:text-sm lg:text-base">Date Published 2</span>
        </a>
      </li>
      <li class="py-5 ">
        <a href="https://tailwindcss.com/docs/height" class="flex flex-col justify-between align-middle">
          ...
          <span class="font-mulish font-normal text-white/60 text-xs md:text-sm lg:text-base">Date Published 3</span>
        </a>
      </li>
    </ul>
  </section>
  ...
  <section 
    ...
    <ul class="m-o p-0 w-full h-auto text-green-900">
      <li class=" pt-2">
