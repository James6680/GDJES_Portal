...
<div class="container container-fluid sm:pl-64 w:full min-h:full">
  ...
  <div class="absolute top-0 -z-50 bg-gradient-to-t from-green-700 to-slate-900 min-w-full h-80">
    Empty
  </div>
              ...
              <div class="flex items-center mb-1">
                  ...
                  <div data-popover id="chart-info" role="tooltip" class="absolute z-10 invisible inline-block text-sm text-gray-500 transition-opacity duration-300 bg-white border border-gray-200 rounded-lg shadow-sm opacity-0 w-72 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-400">
                      <div class="p-3 space-y-2">
                          <h3 class="font-semibold text-black dark:text-white">Activity growth - Incremental</h3>
