<div>
<a href="{{ $href }}" class="group flex font-mulish text-sm items-center p-2 rounded-lg {{ $isActive ? 'text-brown-50 font-bold bg-green-500 hover:bg-green-700 group ' : 'text-green-500 hover:bg-green-50 ' }}">
