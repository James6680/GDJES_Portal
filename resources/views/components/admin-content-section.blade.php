    ...
    <div class="w-full divide-y divide-brown-100 h-full gap-2 md:gap-3 lg:gap-4 p-4 md:p-8 flex flex-col bg-white outline outline-1 outline-brown-100 rounded-lg">  
      ...
      <div class="w-full flex flex-col pt-4">
        ...
        <div class="flex flex-col sm:flex-row w-full h-auto gap-4 pt-4 sm:justify-between">
            ...
            <button id="closeEnrollmentButton" class="text-white bg-red-500 hover:bg-red-600 focus:ring-2 focus:outline-none focus:ring-red-200 font-medium rounded-lg text-sm px-5 my-2 py-2.5 text-left inline-flex items-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800" type="button">
              Close enrollment
            </button>
            @else
