...
<div class="w-full h-full grid grid-cols-1 md:pl-64">
  ...
  <!-- Admin User Accounts Main Content Container -->
  <section class="w-full h-full gap-4 md:gap-16 p-8 pt-12 flex flex-col font-mulish">
    ...
    <div class="w-full h-full gap-2 md:gap-3 lg:gap-4 p-4 md:p-8 flex flex-col bg-white outline outline-1 outline-brown-100 rounded-lg">
      ...
      <div class="flex flex-col gap-2">
        ...
        <p class="mt-1 text-sm font-normal text-gray-500 dark:text-gray-400">This section allows administrators to oversee and manage user accounts efficiently. Accessible functions include viewing, adding, and modifying basic user information. Additionally, administrators can manage confidential data, ensuring the security and integrity of user accounts. Exercise caution and adhere to privacy protocols when handling sensitive information.</p>
      </div>
              ...
              <ul class="p-3 space-y-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownRadioButton">
                ...
                <li>
                  <div class="flex items-center p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-600">
                    ...
                    <label for="filter-radio-example-2" class="w-full ms-2 text-sm font-medium text-gray-900 rounded dark:text-gray-300">Students</label>
                  </div>
                </li>
                <li>
                  <div class="flex items-center p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-600">
                    ...
                    <label for="filter-radio-example-3" class="w-full ms-2 text-sm font-medium text-gray-900 rounded dark:text-gray-300">Teachers</label>
                  </div>
                </li>
              </ul>
            </div>
  ...
  </section> <!-- End of Admin User Accounts Main Content Container -->
