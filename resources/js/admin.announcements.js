...
$(document).ready(function(e) {
    $('#Create').click(function(e) {
      ...
      $.ajax({
        url: localStorage.getItem('appUrl') + "/admin.announcements.create",
        type: "POST",
        data: serializeData,
    ...
    $('#Edit').click(function(e) {
      ...
      console.log(serializeData);
        $.ajax({
          url: localStorage.getItem('appUrl') + "/admin.announcements.edit",
          type: "POST",
          data: serializeData,
          success: function(response) {
            // Form submission is successful, prevent default submission
      ...
      $('#Delete').click(function(e) {
        ...
        console.log(serializeData);
        $.ajax({
          url: localStorage.getItem('appUrl') + "/admin.announcements.delete",
          type: "POST",
          data: serializeData,
          success: function(response) {
            // Form submission is successful, prevent default submission
