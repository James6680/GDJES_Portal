...
function getModeOfLearningStatistics(schoolYearId) {
  const url = '/api/modeOfLearningStatistics/' + schoolYearId;
...
function getLearningInfoStatistics(schoolYearId) {
  const url = '/api/learningInfoStatistics/' + schoolYearId;
  return new Promise((resolve, reject) => {
      $.getJSON(url, function(data) {
...
function getSchoolYear() {
  ...
  const url1 = '/api/schoolYearsWGender';
  return new Promise((resolve, reject) => {
    $.getJSON(url, function(data) {
        schoolYearList = data;
...
function setCurrentSchoolYear(){
  ...
  if(currentSchoolYear){
    ...
    const url = 'api/currentYearStats/' + currentSchoolYear.id;
    $.getJSON(url, function(data) {
